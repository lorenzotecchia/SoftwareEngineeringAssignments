\chapter{Task 3}
\begin{parlist}
\item Assume that only korrekt values are given e.g values in the correct range. A.points are the points from the first test, B.points are the points from the second test.
Aquivalenz Classes:
\begin{list}
