...
\center\includegraphics{Immagini/diagram.png}
...
D because grade C is given to scores with more than 60% of the points and not exactly 60%. This is likely caused by the use of a ">=" instead of a ">" in the conditional statement or a different interpretation of the Requirements.
