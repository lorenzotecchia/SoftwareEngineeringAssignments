...
\hline
Variation      & The webserver could check if the customer has already bought x of the product and reject their offer according to a x per person policy                                                                                                                                                                                                                                                                                                                                                                                                             \\ 
\hline
Non-Functional & The database must be able to handle multiple queries at once in order to process multiple orders at once                                                                                                                                                                                                                                                                                                                                                                                                                                        \\ 
\hline
Issues         & If queries are handeled simultaneously then how do you decide which customer gets a product if there is only one available?                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \\
\hline
\end{tabular}
}
\end{table} 
